...
export default function ChatContainer() {
  ...
  return (
    ...
    <div
      ...
      className="relative flex flex-col overflow-clip app-height max-w-2xl mx-auto border-x border-goshiwon-border night-transition bg-goshiwon-bg text-goshiwon-text goshiwon-atmosphere"
    >
