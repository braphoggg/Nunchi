/** Tutorial step definitions for the interactive onboarding walkthrough. */
...
export const TUTORIAL_STEPS: TutorialStep[] = [
  ...
  },
  {
    ...
    description:
      "The welcome screen offers guided lesson topics — each one teaches a different skill, from beginner greetings to advanced debates. Or skip topics and type anything in the chat box to start a free conversation.",
    type: "observe",
    tooltipPosition: "bottom",
    spotlightPadding: 8,
  },
